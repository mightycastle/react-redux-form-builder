...
const mapStateToProps = (state) => {
  ...
  const { isPageBusy, email, name, isVerifyingCode, isCodeVerified } = signatureVerification || INIT_SIGNATURE_STATE;
  return { isPageBusy, email, name, isVerifyingCode, isCodeVerified };
};
